...
class QwenWebMcpExecutor(BaseExecutor):
    ...
    async def run(self, *, job_id: str, kind: str, input: dict[str, Any], params: dict[str, Any]) -> ExecutorResult:  # noqa: A002
        ...
        return ExecutorResult(
            status="error",
            answer="qwen_web.ask has been retired and is no longer available",
            meta={
                "error_type": "ProviderRemoved",
                "error": "qwen_web.ask has been retired and is no longer available",
