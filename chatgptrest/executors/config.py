...
class ChatGPTExecutorConfig:
    ...
    @cached_property
    def deep_research_send_timeout_seconds(self) -> int:
        return _env_int("CHATGPTREST_CHATGPT_DEEP_RESEARCH_SEND_TIMEOUT_SECONDS", 240)
    ...
    @cached_property
    def thought_guard_require_trace_for_research(self) -> bool:
        return _env_bool("CHATGPTREST_THOUGHT_GUARD_REQUIRE_TRACE_FOR_RESEARCH", True)
    ...
    def wait_transient_failure_limit(self) -> int:
        return _env_int("CHATGPTREST_CHATGPT_WAIT_TRANSIENT_FAILURE_LIMIT", 3)

    @cached_property
    def wait_transient_retry_after_seconds(self) -> float:
        return _env_float("CHATGPTREST_CHATGPT_WAIT_TRANSIENT_RETRY_AFTER_SECONDS", 90.0)

    @cached_property
    def self_check_timeout_seconds(self) -> int:
        return _env_int("CHATGPTREST_CHATGPT_SELF_CHECK_TIMEOUT_SECONDS", 45)

    @cached_property
    def send_transient_retry_limit(self) -> int:
        return _env_int("CHATGPTREST_CHATGPT_SEND_TRANSIENT_RETRY_LIMIT", 2)
...
class GeminiExecutorConfig:
    ...
    def send_retry_delay(self) -> float:
        return _env_float("CHATGPTREST_GEMINI_SEND_RETRY_DELAY", 90.0)
    ...
    @cached_property
    def wait_transient_retry_after_seconds(self) -> float:
        return _env_float("CHATGPTREST_GEMINI_WAIT_TRANSIENT_RETRY_AFTER_SECONDS", 90.0)
