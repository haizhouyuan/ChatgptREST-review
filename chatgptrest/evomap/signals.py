...
Signal types collected by the Observer:
  ...
  - skill.suggested / skill.selected / skill.executed
  - skill.succeeded / skill.failed / skill.helpful / skill.unhelpful
  - skill.promoted / skill.deprecated
  - capability.gap.opened / capability.gap.closed
...
class SignalType:
    ...
    SKILL_HELPFUL = "skill.helpful"
    SKILL_UNHELPFUL = "skill.unhelpful"
    SKILL_PROMOTED = "skill.promoted"
    SKILL_DEPRECATED = "skill.deprecated"
    CAPABILITY_GAP_OPENED = "capability.gap.opened"
    CAPABILITY_GAP_CLOSED = "capability.gap.closed"
