...
from chatgptrest.evomap.knowledge.ingest_quality import default_activity_promotion
...
class ActivityIngestService:
    ...
    def ingest_activity_event(self, event_data: dict) -> IngestResult:
        ...
        promotion_status, promotion_reason = default_activity_promotion(event_type)
        atom = Atom(
            atom_id=atom_id,
            episode_id=ep_id,
            atom_type="lesson",
