...
FINAGENT_ROOT = Path("/vol1/1000/projects/finagent")
...
FINBOT_ARTIFACT_ROOT_CANDIDATES = (
    Path("/vol1/1000/projects/ChatgptREST/artifacts/finbot"),
    Path(__file__).resolve().parents[2] / "artifacts" / "finbot",
)
