    ...
    with _INIT_LOCK:
        ...
        try:
            ...
            if feishu_client.enabled:
                ...
                logger.info("FeishuApiClient not configured — bot replies disabled")
        except ModuleNotFoundError as exc:
            if exc.name != "chatgptrest.advisor.feishu_api_client":
                raise
            logger.info("FeishuApiClient module unavailable — bot replies disabled")
