...
- fetched_at: 2026-03-31T12:44:55+08:00
- extract_method: jina

Title: New tools and features in the Responses API

URL Source: https://openai.com/index/new-tools-and-features-in-the-responses-api/

Markdown Content:
# New tools and features in the Responses API | OpenAI

[Skip to main content](https://openai.com/index/new-tools-and-features-in-the-responses-api/#main)
...
*   [New remote MCP server support](https://openai.com/index/new-tools-and-features-in-the-responses-api/#new-remote-mcp-server-support)
*   [Updates to image generation, Code Interpreter, and file search](https://openai.com/index/new-tools-and-features-in-the-responses-api/#updates-to-image-generation-code-interpreter-and-file-search)
*   [New features in the Responses API](https://openai.com/index/new-tools-and-features-in-the-responses-api/#new-features-in-the-responses-api)
*   [Pricing and availability](https://openai.com/index/new-tools-and-features-in-the-responses-api/#pricing-and-availability)
...
![Image 1: Pitch. Skin checkout page showing express options (Shop Pay, PayPal, G Pay), contact and delivery form fields, and an order summary for one ‘Blemish Toner Pads 200 mL (120 pads)’ priced at AUD $49.](https://images.ctfassets.net/kftzwdyauwt9/4tJh30qd64hXN5bcEFxQUa/09162bd854c113ecb5feb836316e4cb0/Screenshot_2025-05-20_at_4.14.13%C3%A2__PM.png?w=3840&q=90&fm=webp)
