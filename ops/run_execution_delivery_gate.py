...
from chatgptrest.eval.execution_delivery_gate import run_execution_delivery_gate, write_execution_delivery_gate_report


OUT_DIR = Path("docs/dev_log/artifacts/phase18_execution_delivery_gate_20260322")
...
def main() -> int:
    ...
    json_path, md_path = write_execution_delivery_gate_report(
        report,
        out_dir=OUT_DIR,
