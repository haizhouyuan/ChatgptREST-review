...
def build_queue(
    *,
    ...
    for decision in decisions:
        if str(decision.get("review_decision") or "").strip() != "defer":
            continue
    ...
    summary = {
        ...
        "output_tsv": str(out),
        "total_deferred_candidates": len(rows),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a defer-only revisit queue from execution experience review decisions.")
