...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Backlog janitor: identify stale jobs/issues and optionally mitigate stale issues")
    ...
    p.add_argument("--apply", action="store_true", help="Apply stale issue mitigation updates")
    return p
