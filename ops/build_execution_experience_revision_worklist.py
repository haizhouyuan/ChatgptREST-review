...
def build_worklist(
    *,
    ...
    for decision in decisions:
        if str(decision.get("review_decision") or "").strip() != "revise":
            continue
    ...
    summary = {
        ...
        "output_tsv": str(out),
        "total_revise_candidates": len(rows),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build a revise-only worklist from execution experience review decisions.")
