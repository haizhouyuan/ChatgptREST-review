...
def test_strategy_plan_executes_visit_cooperation_prep_without_forcing_clarify() -> None:
    contract = AskContract(
        objective=(
    ...
    plan = build_strategy_plan(
        ...
        context={
            ...
            "scenario_pack": {
                ...
                "route_hint": "report",
                "watch_policy": {"checkpoint": "quality_gate"},
                "clarify_questions": [
