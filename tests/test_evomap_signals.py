...
class TestSignalType:
    ...
    def test_signal_type_constants_exist(self):
        ...
        assert signals.SignalType.SKILL_SUGGESTED == "skill.suggested"
        assert signals.SignalType.SKILL_SELECTED == "skill.selected"
        assert signals.SignalType.SKILL_EXECUTED == "skill.executed"
        assert signals.SignalType.SKILL_SUCCEEDED == "skill.succeeded"
        assert signals.SignalType.SKILL_FAILED == "skill.failed"
        assert signals.SignalType.SKILL_HELPFUL == "skill.helpful"
        assert signals.SignalType.SKILL_UNHELPFUL == "skill.unhelpful"
        assert signals.SignalType.SKILL_PROMOTED == "skill.promoted"
        assert signals.SignalType.SKILL_DEPRECATED == "skill.deprecated"
        assert signals.SignalType.CAPABILITY_GAP_OPENED == "capability.gap.opened"
        assert signals.SignalType.CAPABILITY_GAP_CLOSED == "capability.gap.closed"
