...
class TestValidateKindPreset:
    ...
    def test_removed_qwen_provider(self) -> None:
        with pytest.raises(cli_mod.CliError, match="retired"):
            cli_mod._validate_kind_preset(kind="qwen_web.ask", params_obj={"preset": "deep_research"})
